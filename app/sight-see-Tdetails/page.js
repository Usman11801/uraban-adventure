...
const page = () => {
  ...
  const faqItem = [
    {
      id: 1,
      title: "1. Do I get picked from hotel when I book a Sightseeing Tour?",
      answer:
        "Yes we shall pick you from your hotel / residence for Sightseeing Tours. And there is no additional charges for Pick it's included in the Price .",
    },
    {
      id: 2,
      title: "2. How long is the Sightseeing Tour?",
      answer:
        "Sightseeing Tours typically last 4 to 8 hours depending on the package selected.",
    },
    {
      id: 3,
      title: "3. Can I customize my Sightseeing Tour?",
      answer: "Yes, sightseeing tours can be customized according to your preferences and interests.",
    },
    {
      id: 4,
      title: "4. What is included in the Sightseeing Tour?",
      answer:
        "Sightseeing tours include hotel pickup and drop-off, professional guide, and all activities mentioned in the package.",
    },
    {
      id: 6,
      title:
        "6. What is the maximum number of people who can go on a Sightseeing Tour?",
      answer:
