                  ...
                  >
                    ...
                    <div className="content">
                      ...
                      <div className="text">
                        ...
                        <a href="mailto:urbanadventuretourism@gmail.com">urbanadventuretourism@gmail.com
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="content">
                      ...
                      <div className="text">
                        ...
                        <a href="+971528067631">+971528067631</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  ...
                  >
                    ...
                    <div className="content">
                      <h5>UAE Branch</h5>
                      <div className="text">
                        <i className="fal fa-map-marker-alt" /> Al zahraa techno center al rafa office 101 Dubai UAE
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-5">
              ...
              >
                <div className="row">
                  ...
                  <div className="col-6">
                    <img
                      src="assets/images/destinations/dhabi5.jpg"
                      alt="Contact"
                    />
                  </div>
                  <div className="col-6">
