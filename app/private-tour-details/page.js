...
const page = () => {
  ...
  const faqItem = [
    {
      id: 1,
      title: "1. Do I get picked from hotel when I book a Private Tour?",
      answer:
        "Yes we shall pick you from your hotel / residence for Private Tours. And there is no additional charges for Pick it's included in the Price .",
    },
    {
      id: 2,
      title: "2. How long is the Private Tour?",
      answer:
        "Private Tours duration varies based on the package selected. Typically ranges from 4 to 8 hours.",
    },
    {
      id: 3,
      title: "3. Can I customize my Private Tour?",
      answer: "Yes, private tours can be customized according to your preferences and interests.",
    },
    {
      id: 4,
      title: "4. What is included in the Private Tour?",
      answer:
        "Private tours include hotel pickup and drop-off, professional guide, and all activities mentioned in the package.",
    },
    {
      id: 6,
      title:
        "6. What is the maximum number of people who can go on a Private Tour?",
      answer:
        "Private tours can accommodate small groups. The exact number depends on the vehicle type and package selected.",
    },
  ];
