...
const page = () => {
  ...
  // Get all available images (top-tour uses single image field)
  const heroImages = tour && tour.image ? [tour.image] : [];

  // Auto-rotate images every 4.5 seconds (if multiple images available)
  useEffect(() => {
  ...
  const faqItem = [
    ...
    },
    {
      ...
      answer:
        "Yes, vegetarian food options are available as part of the safari.",
    },
    {
      id: 6,
      title:
