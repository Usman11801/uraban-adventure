...
const page = () => {
  ...
  const faqItem = [
    ...
    // },
    {
      ...
      answer:
        "There is no limit to that as we have many cars and can arrange many more if needed. Also no matter how many people are there in the safari only 6 to 7 people get in to a 4x4 ( including the driver ) so the size of the group does not effect the quality of the tour.",
    },
  ];
